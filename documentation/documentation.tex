...
bool IsClockwise(const Triangle& triangle, const glm::vec3& polyCenter)
{
	...
	Now, let us delve into this code with illustrations. Consider a convex polyhedron. We can easily calculate its center point by adding up all the vertices and then dividing by their count. For simplicity, I have chosen a tetrahedron:
