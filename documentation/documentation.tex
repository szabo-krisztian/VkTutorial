...
bool IsClockwise(const Triangle& triangle, const glm::vec3& polyCenter)
{
	...
	Let us start with the simpler solutions. First, let us have two points in space $p_1, \, p_2 \in \R^3$. These define the following segment:
	\[
	...
	\begin{center}
		...
		\begin{tikzpicture}[tdplot_main_coords, scale=2]
		  ...
		  \draw[thick,<->] (0,-3.5,0) -- (0,3.5,0) node[anchor=north west]{$y$};
		  \draw[thick,<->] (0,0,-0.5) -- (0,0,3.5) node[anchor=south]{$z$};
		  
		  \drawcube{-1}{-1}{0}{red, dashed}
		  \drawcube{-1}{0}{0}{red, dashed}
		  \drawcube{0}{0}{0}{red, dashed}
		  \drawcube{0}{1}{0}{red, dashed}
		  \drawcube{1}{1}{0}{red, dashed}
		  \drawcube{1}{1}{1}{red, dashed}
		  \drawcube{1}{2}{1}{red, dashed}
		  \drawcube{2}{2}{1}{red, dashed}
		
		  \coordinate (A) at (-0.64602,-0.57894,0.2027);
		  \coordinate (B) at (2.07, 2.25, 1.5);
		  \draw[thick, red] (A) -- (B);
		...
		\begin{tikzpicture}[tdplot_main_coords, scale=2]
		  ...
		  \foreach \i in {-1,0,1,2} {
			\foreach \j in {-1,0,1,2} {
			  \foreach \k in {0,1} {
				\drawcube{\i}{\j}{\k}{black, dotted, thin};
			  }
			}
		  }
